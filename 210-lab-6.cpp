...
// function to enter values into the array
...
void outputArray(double* arr, int size) {
    ...
    // function to sum values in the array
    ...
    int main() {
        double* arr = new double[SIZE]; // dynamically allocate array
